...
class DesktopAppTests(unittest.TestCase):
    ...
    def test_existing_ui_gets_desktop_settings_and_item_edit_controls(self):
        ...
        import_html = client.get("/settings?view=import").get_data(as_text=True)
        ...
        self.assertIn('desktop-lan-panel" hidden', import_html)
        ...
        self.assertIn("/settings?view=import", inventory_html)
